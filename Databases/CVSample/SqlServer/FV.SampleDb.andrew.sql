...
-- The filegroup for the Core (non index) objects
, filegroup Core
( name = N'Core'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\FamilyView_Core.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
, filegroup CoreIdx 
( name = N'CoreIdx'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\FamilyView_CoreIdx.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
