...
--
CREATE TABLE CV.TaskProcessingQueue
(
	...
	CONSTRAINT TaskProcsssingQueue_FK_TaskRegistrations 
		FOREIGN KEY (TaskId) REFERENCES CV.TaskRegistrations(TaskId),
	CONSTRAINT TaskProcsssingQueue_FK_TaskStatusCodes
		FOREIGN KEY (StatusCode) REFERENCES CV.TaskStatusCodes(StatusCode),
	CONSTRAINT TaskProcsssingQueue_FK_AppMaster_ProcessEngineId
		FOREIGN KEY (ProcessEngineId) REFERENCES CV.AppMaster (AppId),
	CONSTRAINT TaskProcsssingQueue_FK_AppMaster_WaitForEngineId 
		FOREIGN KEY (WaitForEngineId) REFERENCES CV.AppMaster (AppId),
	CONSTRAINT TaskProcsssingQueue_FK_TaskConfigurations 
		FOREIGN KEY (WaitForConfigId) REFERENCES CV.TaskConfigurations(ConfigId),
	CONSTRAINT TaskProcsssingQueue_FK_UserMaster_Code
		FOREIGN KEY (LastModifiedUserCode) REFERENCES CV.UserMaster(UserCode),
