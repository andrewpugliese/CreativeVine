...
EXEC CV.usp_UniqueIdsGetNextRange 'AccessControlGroupCode', 1, @uVBgc out

INSERT INTO CV.AccessControlGroups (AccessControlGroupCode, AccessControlGroupName, DefaultAccessDenied, Remarks)
VALUES
(
...
EXEC CV.usp_UniqueIdsGetNextRange 'UserCode', 1, @uc out

INSERT INTO CV.UserMaster
(
	UserCode
	, UserId
	, UserPassword
...
EXEC CV.usp_UniqueIdsGetNextRange 'ViewBookId', 1, @puglieseViewBook out

INSERT INTO FV.ViewBooks(ViewBookId, Title, StartedByUserCode)
VALUES (@puglieseViewBook, 'The Pugliese Family ViewBook', @andrew)
		
EXEC CV.usp_UniqueIdsGetNextRange 'ViewBookId', 1, @singhalViewBook out
...
EXEC CV.usp_UniqueIdsGetNextRange 'ContentId', 1, @contentId out
