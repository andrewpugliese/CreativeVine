...
namespace CV.Logging
{
    ...
    {   
        ...
        {
            Write(message, false, null, EventLogEntryType.Information, EventPriorities.Trace);
        }
        ...
        public void Write(string message, bool appendText, long? eventReference, 
                System.Diagnostics.EventLogEntryType entryType, EventPriorities eventPriority)
        {
        ...
        {
            get { throw new ExceptionMgr(this.ToString(), new NotImplementedException()); }
        }
